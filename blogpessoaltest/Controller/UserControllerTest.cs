...
namespace blogpessoaltest.Controllers
{
    public class UserControllerTest : IClassFixture<WebAppFactory>
    {
            ...
            var credenciais = new Dictionary<string, string>
        {
            ...
            var credenciaisJson = JsonConvert.SerializeObject(credenciais);

            var corpoRequisicao = new StringContent(credenciaisJson, Encoding.UTF8, "application/json");
            ...
            var token = await resposta.Content.ReadAsStringAsync();
